...
# AndGate принимает два, выдает один
# OrGate принимает два, выдает один
# NotGate принимает один, выдает один
/*
 * Коннектор - может принимать 1 или два параметра на вход
 * Отдает с каждого вентиля 1 ответ
 * Если на прием идет 1 параметр, берется первый
 */
